    ...
    String spam;
		try {
			...
			while (line != null) {
				...
				try{
				int spam1=Naivebayes.getcount(line.split(",")[8]+","+"spam");
				int ham=Naivebayes.getcount(line.split(",")[8]+","+"ham");
				
				if((spam1/(spam1+ham))>(ham/(spam1+ham))){
					spam="spam";
	    ...
	    session.setAttribute("name", "Naive bayes");
