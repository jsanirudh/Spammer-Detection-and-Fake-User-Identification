    ...
    String spam;
		try {
			...
			while (line != null) {
				...
				try{
				int spam1=random.getcount(line.split(",")[8]+","+"spam");
				int ham=random.getcount(line.split(",")[8]+","+"ham");
	    ...
	    session.setAttribute("RandomForest", accuracy);
	    session.setAttribute("name", "Random Forest");
