...
">
    ...
    int j=1;
		try {
			reader = new BufferedReader(new FileReader("C:/Users/amma/Desktop/tweets.csv"));
			...
			while (line != null) {
				...
				try{
					if(line.split(",")[9].equals("spam")){
						svm.adddataspam(line.split(",")[8]);
					}
					if(line.split(",")[9].equals("ham")){
						svm.adddataham(line.split(",")[8]);
					}
