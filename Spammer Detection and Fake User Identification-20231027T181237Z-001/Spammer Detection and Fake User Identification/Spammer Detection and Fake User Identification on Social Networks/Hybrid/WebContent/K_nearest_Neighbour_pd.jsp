<%@page import="com.hybrid.K_nearest_Neighbour"%>
    ...
    K_nearest_Neighbour.adddata();
		try {
			...
			while (line != null) {
				...
				try{
					for(int i=0;i<line.split(",")[8].split(" ").length;i++){
						total+=K_nearest_Neighbour.nagitive(line.split(",")[8].split(" ")[i]);
					}
	    ...
	    session.setAttribute("name", "K nearest Neighbour");
